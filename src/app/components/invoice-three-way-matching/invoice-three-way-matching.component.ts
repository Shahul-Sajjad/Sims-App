...
export class InvoiceThreeWayMatchingComponent implements OnInit {
  ...
  displayedInvoiceColumns: String[] = ['statuIcon','po', 'poLine', 'lineOrderQuantity', 'invoiceQty', 'grnQty', 'poLineRate', 'invoiceLineRate', 'grnPrice', 'poUom', 'invoiceUom', 'grnUom', 'material', 'lineMaterialDesc', 'poAmt', 'invoiceAmount', 'grnAmount', 'threeWayMatchingStatus'];
