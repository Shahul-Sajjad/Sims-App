...
export class VendorBankDetailTabComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    setTimeout(() => {
      this.vendorId = localStorage.getItem('vendorCode');
  ...
  getVendorBankDetails(VendorId: string) {
    ...
    this.simsHttpCoreServices.httpPost(this.soapRequest).subscribe(VendorBankDetailResult => {
      ...
      vendorBankDetail.map((x, index) => {
        let vendorBankDetailModel = {
          beneficiary: x.old[0].mtr_vendor_bank_details[0].beneficary[0] instanceof Object ? "" : x.old[0].mtr_vendor_bank_details[0].beneficary[0],
          bank_name: x.old[0].mtr_vendor_bank_details[0].bank_name[0] instanceof Object ? "" : x.old[0].mtr_vendor_bank_details[0].bank_name[0],
          account_no: x.old[0].mtr_vendor_bank_details[0].account_no[0] instanceof Object ? "" : x.old[0].mtr_vendor_bank_details[0].account_no[0],
          swift: x.old[0].mtr_vendor_bank_details[0].swift[0] instanceof Object ? "" : x.old[0].mtr_vendor_bank_details[0].swift[0],
          iban: x.old[0].mtr_vendor_bank_details[0].iban[0] instanceof Object ? "" : x.old[0].mtr_vendor_bank_details[0].iban[0],
          bank_key: x.old[0].mtr_vendor_bank_details[0].bank_key[0] instanceof Object ? "" : x.old[0].mtr_vendor_bank_details[0].bank_key[0],
          partner_bank_type: x.old[0].mtr_vendor_bank_details[0].partner_bank_type[0] instanceof Object ? "" : x.old[0].mtr_vendor_bank_details[0].partner_bank_type[0],
          ifsc: x.old[0].mtr_vendor_bank_details[0].ifsc_code[0] instanceof Object ? "" : x.old[0].mtr_vendor_bank_details[0].ifsc_code[0],
          alternate_payee: x.old[0].mtr_vendor_bank_details[0].altenate_payee[0] instanceof Object ? "" : x.old[0].mtr_vendor_bank_details[0].altenate_payee[0],
          currency_type: x.old[0].mtr_vendor_bank_details[0].curr_type[0] instanceof Object ? "" : x.old[0].mtr_vendor_bank_details[0].curr_type[0],
        }
